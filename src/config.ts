...
export const GISCUS: GiscusProps = {
  repo: "hallm74/all-things-sabine",
  repoId: "R_kgDONZJpog",
  category: "General",
  categoryId: "DIC_kwDONZJpos4ClPwL",
  mapping: "pathname",
  reactionsEnabled: "1",
  emitMetadata: "0",
...
export const SOCIALS: SocialObjects = [
  {
    name: "Github",
    href: "https://github.com/hallm74/all-things-sabine",
    linkTitle: ` ${SITE.title} on Github`,
    active: true,
  },
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/15WVrhtAgn/?mibextid=LQQJ4d",
